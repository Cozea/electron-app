...
export class AssetThreadArtifactNotFoundError extends Schema.TaggedError<AssetThreadArtifactNotFoundError>()(
...
export class AssetThreadArtifactInspectionError extends Schema.TaggedError<AssetThreadArtifactInspectionError>()(
