...
export const make = Effect.fn("effect-acp/AcpClient.make")(function (
  ...
  const shape: AcpClientShape = {
    ...
    agent: {
      initialize: (payload: AcpSchema.InitializeRequest) => callRpc(rpc[AGENT_METHODS.initialize](payload)),
      authenticate: (payload: AcpSchema.AuthenticateRequest) => callRpc(rpc[AGENT_METHODS.authenticate](payload)),
      logout: (payload: AcpSchema.LogoutRequest) => callRpc(rpc[AGENT_METHODS.logout](payload)),
      createSession: (payload: AcpSchema.NewSessionRequest) => callRpc(rpc[AGENT_METHODS.session_new](payload)),
      loadSession: (payload: AcpSchema.LoadSessionRequest) => callRpc(rpc[AGENT_METHODS.session_load](payload)),
      listSessions: (payload: AcpSchema.ListSessionsRequest) => callRpc(rpc[AGENT_METHODS.session_list](payload)),
      forkSession: (payload: AcpSchema.ForkSessionRequest) => callRpc(rpc[AGENT_METHODS.session_fork](payload)),
      resumeSession: (payload: AcpSchema.ResumeSessionRequest) => callRpc(rpc[AGENT_METHODS.session_resume](payload)),
      closeSession: (payload: AcpSchema.CloseSessionRequest) => callRpc(rpc[AGENT_METHODS.session_close](payload)),
      setSessionModel: (payload: AcpSchema.SetSessionModelRequest) => callRpc(rpc[AGENT_METHODS.session_set_model](payload)),
      setSessionConfigOption: (payload: AcpSchema.SetSessionConfigOptionRequest) =>
        callRpc(rpc[AGENT_METHODS.session_set_config_option](payload)),
      prompt: (payload: AcpSchema.PromptRequest) => callRpc(rpc[AGENT_METHODS.session_prompt](payload)),
      cancel: (payload: any) => transport.notify(AGENT_METHODS.session_cancel, payload),
    },
