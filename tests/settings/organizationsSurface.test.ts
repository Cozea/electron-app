...
import { OrganizationSettingsTabs } from "@/features/settings/pages/Organizations"
...
describe("organizations settings surface", () => {
  ...
  it("places the invite action above the members list", () => {
    const source = readFileSync(
      resolve(process.cwd(), "apps/desktop/src/features/settings/pages/Organizations.tsx"),
      "utf8",
    )
