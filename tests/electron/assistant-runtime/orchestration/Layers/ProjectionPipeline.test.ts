...
import { OrchestrationEventStore } from "../../../../../electron/assistant-runtime/persistence/Services/OrchestrationEventStore.ts";
import { OrchestrationEngineLive } from "../../../../../electron/assistant-runtime/orchestration/Layers/OrchestrationEngine.ts";
import {
  ORCHESTRATION_PROJECTOR_NAMES,
  OrchestrationProjectionPipelineLive,
} from "../../../../../electron/assistant-runtime/orchestration/Layers/ProjectionPipeline.ts";
import { OrchestrationEngineService } from "../../../../../electron/assistant-runtime/orchestration/Services/OrchestrationEngine.ts";
import { OrchestrationProjectionPipeline } from "../../../../../electron/assistant-runtime/orchestration/Services/ProjectionPipeline.ts";
...
const BaseTestLayer = makeProjectionPipelinePrefixedTestLayer("cozea-projection-pipeline-test-");
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("cozea-base-")))(
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("cozea-projection-attachments-safe-")))(
  "OrchestrationProjectionPipeline",
  (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("cozea-projection-attachments-overwrite-")),
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("cozea-projection-attachments-rollback-")),
)("OrchestrationProjectionPipeline", (it) => {
    ...
    Effect.gen(function* () {
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointRef: CheckpointRef.makeUnsafe("refs/cozea/checkpoints/thread-revert-files/turn/1"),
          status: "ready",
          files: [],
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointRef: CheckpointRef.makeUnsafe("refs/cozea/checkpoints/thread-revert-files/turn/2"),
          status: "ready",
          files: [],
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("cozea-projection-attachments-revert-")))(
  "OrchestrationProjectionPipeline",
  (it) => {
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("cozea-projection-attachments-delete-")))(
  "OrchestrationProjectionPipeline",
  (it) => {
      ...
      Effect.gen(function* () {
        ...
        yield* appendAndProject({
          ...
          payload: {
            ...
            turnId: TurnId.makeUnsafe("turn-completed"),
            checkpointTurnCount: 1,
            checkpointRef: CheckpointRef.makeUnsafe("refs/cozea/checkpoints/thread-conflict/turn/1"),
            status: "ready",
            files: [],
    ...
    Effect.gen(function* () {
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointTurnCount: 1,
          checkpointRef: CheckpointRef.makeUnsafe("refs/cozea/checkpoints/thread-revert/turn/1"),
          status: "ready",
          files: [],
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointTurnCount: 2,
          checkpointRef: CheckpointRef.makeUnsafe("refs/cozea/checkpoints/thread-revert/turn/2"),
          status: "ready",
          files: [],
    ...
    Effect.provide(
      Layer.provideMerge(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "cozea-projection-pipeline-restart-",
        }),
        NodeServices.layer,
      ),
    ),
...
const engineLayer = it.layer(
  OrchestrationEngineLive.pipe(
    ...
    Layer.provideMerge(
      ServerConfig.layerTest(process.cwd(), {
        prefix: "cozea-projection-pipeline-engine-dispatch-",
      }),
    ),
    Layer.provideMerge(NodeServices.layer),
  ),
