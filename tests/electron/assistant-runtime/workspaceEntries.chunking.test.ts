...
import type { ProcessRunOptions, ProcessRunResult } from "../../../electron/assistant-runtime/processRunner";
...
describe("searchWorkspaceEntries git-ignore chunking", () => {
  ...
  it("chunks git check-ignore stdin to avoid building giant strings", async () => {
    ...
    const { searchWorkspaceEntries } = await import("../../../electron/assistant-runtime/workspaceEntries");
