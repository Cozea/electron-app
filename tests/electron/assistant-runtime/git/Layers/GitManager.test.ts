...
import type { GitActionProgressEvent } from "@cozea/assistant-contracts";

import { GitCommandError, GitHubCliError, TextGenerationError } from "../../../../../electron/assistant-runtime/git/Errors.ts";
import { type GitManagerShape } from "../../../../../electron/assistant-runtime/git/Services/GitManager.ts";
import {
  type GitHubCliShape,
  type GitHubPullRequestSummary,
  GitHubCli,
} from "../../../../../electron/assistant-runtime/git/Services/GitHubCli.ts";
import { type TextGenerationShape, TextGeneration } from "../../../../../electron/assistant-runtime/git/Services/TextGeneration.ts";
import { GitCoreLive } from "../../../../../electron/assistant-runtime/git/Layers/GitCore.ts";
import { GitCore } from "../../../../../electron/assistant-runtime/git/Services/GitCore.ts";
import { makeGitManager } from "../../../../../electron/assistant-runtime/git/Layers/GitManager.ts";
...
const GitManagerTestLayer = GitCoreLive.pipe(
  Layer.provide(ServerConfig.layerTest(process.cwd(), { prefix: "cozea-git-manager-test-" })),
  Layer.provideMerge(NodeServices.layer),
);
