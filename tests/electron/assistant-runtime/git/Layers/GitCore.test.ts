...
import { GitCoreLive, makeGitCore } from "../../../../../electron/assistant-runtime/git/Layers/GitCore.ts";
...
const ServerConfigLayer = ServerConfig.layerTest(process.cwd(), { prefix: "cozea-git-core-test-" });
