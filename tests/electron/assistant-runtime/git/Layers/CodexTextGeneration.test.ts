...
import { CodexTextGenerationLive } from "../../../../../electron/assistant-runtime/git/Layers/CodexTextGeneration.ts";
import { TextGenerationError } from "../../../../../electron/assistant-runtime/git/Errors.ts";
import { TextGeneration } from "../../../../../electron/assistant-runtime/git/Services/TextGeneration.ts";
  ...
  return Effect.gen(function* () {
    ...
    yield* fs.writeFileString(
      ...
      [
        ...
        "  cat > \"$output_path\" <<'__COZEA_ASSISTANT_FAKE_CODEX_OUTPUT__'",
        input.output,
        "__COZEA_ASSISTANT_FAKE_CODEX_OUTPUT__",
        "fi",
