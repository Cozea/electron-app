...
import * as EffectAcpErrors from "@cozea/effect-acp/errors";
import type * as EffectAcpSchema from "@cozea/effect-acp/schema";
import type * as EffectAcpProtocol from "@cozea/effect-acp/protocol";
...
export class AcpSessionRuntime extends ServiceMap.Service<AcpSessionRuntime, AcpSessionRuntimeShape>()(
  "effect-acp/AcpSessionRuntime",
) {}

export const layerAcpSessionRuntime = (
  options: AcpSessionRuntimeOptions,
): Layer.Layer<
  AcpSessionRuntime,
  EffectAcpErrors.AcpError,
  ChildProcessSpawner.ChildProcessSpawner
> => Layer.effect(AcpSessionRuntime, makeAcpSessionRuntime(options));
