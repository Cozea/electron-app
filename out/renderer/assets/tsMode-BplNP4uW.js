import { d as createWebWorker, e as editor, U as Uri, f as MarkerTag, M as MarkerSeverity, l as languages, t as typescriptDefaults, R as Range } from "./index-CWKXLA22.js";
class WorkerManager {
      ...
      this._client = (async () => {
        this._worker = createWebWorker({
          ...
          createWorker: () => new Worker(new URL(
            /* @vite-ignore */
            "" + new URL("ts.worker-B7YPqCqw.js", import.meta.url).href,
            import.meta.url
          ), { type: "module" }),
          label: this._modeId,
          keepIdleModels: true,
