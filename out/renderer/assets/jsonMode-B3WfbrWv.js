import { d as createWebWorker, l as languages, e as editor } from "./index-CWKXLA22.js";
import { f as DocumentFormattingEditProvider, g as DocumentRangeFormattingEditProvider, C as CompletionAdapter, H as HoverAdapter, b as DocumentSymbolAdapter, d as DocumentColorAdapter, F as FoldingRangeAdapter, S as SelectionRangeAdapter, e as DiagnosticsAdapter } from "./lspLanguageFeatures-CMRj6p2T.js";
import { a, D, h, R, c, i, j, t, k } from "./lspLanguageFeatures-CMRj6p2T.js";
    ...
    if (!this._client) {
      this._worker = createWebWorker({
        ...
        createWorker: () => new Worker(new URL(
          /* @vite-ignore */
          "" + new URL("json.worker-D4JVmXIe.js", import.meta.url).href,
          import.meta.url
        ), { type: "module" }),
