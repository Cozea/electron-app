    ...
    if (!this._client) {
      this._worker = createWebWorker({
        ...
        createWorker: () => new Worker(new URL(
          /* @vite-ignore */
          "" + new URL("css.worker-umuuUiIb.js", import.meta.url).href,
          import.meta.url
        ), { type: "module" }),
