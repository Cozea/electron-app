import { d as createWebWorker, l as languages } from "./index-CWKXLA22.js";
import { H as HoverAdapter, D as DocumentHighlightAdapter, h as DocumentLinkAdapter, F as FoldingRangeAdapter, b as DocumentSymbolAdapter, S as SelectionRangeAdapter, c as RenameAdapter, f as DocumentFormattingEditProvider, g as DocumentRangeFormattingEditProvider, C as CompletionAdapter } from "./lspLanguageFeatures-CMRj6p2T.js";
import { a, e, d, R, i, j, t, k } from "./lspLanguageFeatures-CMRj6p2T.js";
    ...
    if (!this._client) {
      this._worker = createWebWorker({
        ...
        createWorker: () => new Worker(new URL(
          /* @vite-ignore */
          "" + new URL("html.worker-BT47iy49.js", import.meta.url).href,
          import.meta.url
        ), { type: "module" }),
