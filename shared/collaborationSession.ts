...
export function advancePublishedCollaborationBase(
  ...
  // Binary-only commits may publish a new Git tree at the same shared-text
  // barrier. The prepared commit and renewable lease authorize this exact SHA;
  // durable publication revisions order those commits independently of CRDT seq.
