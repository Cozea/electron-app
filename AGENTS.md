...
- **AI Runtime**: Vendored T3 server (`apps/server/` + `vendor/t3code`) spawned by shadow child; local Effect-TS substrate in `electron/substrate/`
...
│   ├── substrate/              # Shadow server helpers, providers, VCS, migrations
