...
const themes: { value: Theme; label: string; colors: { bg: string; card: string; primary: string; muted: string } }[] = [
  ...
  },
  {
    value: 'system',
    label: 'System',
    colors: { bg: 'linear-gradient(135deg, #ffffff 50%, #1a1a1a 50%)', card: '', primary: '', muted: '' }
  },
]
...
export function Appearance() {
  ...
  return (
    ...
    >
      <div className="max-w-3xl space-y-8 px-6 pt-6">
        {/* Theme */}
        <div>
              ...
              return (
                ...
                >
                  ...
                  <div
                    ...
                    style={{ background: isSystem ? t.colors.bg : t.colors.bg }}
                  >
                    {isSystem ? (
                      ...
                      <div className="h-full flex flex-col gap-1">
                        ...
                        >
                          ...
                          />
                          <div
                            className="h-1 w-3/4 rounded-sm mb-1"
                            style={{ backgroundColor: t.colors.muted }}
                          />
                          <div
