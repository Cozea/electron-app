...
export type WorkbenchEditorIcon = React.FC<SVGProps<SVGSVGElement>>

export const CursorIcon: WorkbenchEditorIcon = (props) => (
...
export const VisualStudioCodeIcon: WorkbenchEditorIcon = (props) => {
  const id = useId()
...
export const ZedIcon: WorkbenchEditorIcon = (props) => {
  const id = useId()
...
export const AntigravityIcon: WorkbenchEditorIcon = (props) => (
