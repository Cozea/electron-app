  ...
  return (
    <article className="flex p-4 sm:p-6 hover:bg-muted/5 transition-colors">
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <div className="flex w-fit ml-auto items-center gap-4 text-muted-foreground mb-1 mt-1 border border-border/60 rounded-full px-3 py-1.5 shadow-sm bg-background">
