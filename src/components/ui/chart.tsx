...
type ChartTooltipItem = TooltipPayloadEntry<ChartValueType, ChartNameType>
type RechartsTooltipContentProps = TooltipContentProps<ChartValueType, ChartNameType>
...
const ChartTooltipContent = React.forwardRef<
  ...
  > &
    React.ComponentProps<"div"> & {
      ...
      active?: boolean
      coordinate?: RechartsTooltipContentProps["coordinate"]
      accessibilityLayer?: boolean
      activeIndex?: RechartsTooltipContentProps["activeIndex"]
      hideLabel?: boolean
            ...
            return (
              ...
              >
                {formatter && item?.value !== undefined && item.name ? (
                  formatter(item.value, item.name, item, index, payload as unknown as ChartTooltipItem[])
                ) : (
                  <>
                    {itemConfig?.icon ? (
                      <itemConfig.icon />
