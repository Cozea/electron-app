export const title = "React AI Model Selector";
...
export const ModelSelectorList = ({ className, ...props }: ModelSelectorListProps) => (
  <CommandList className={cn("max-h-64", className)} {...props} />
);
...
export const ModelSelectorLogoGroup = ({
  ...
  <div
    className={cn(
      "-space-x-1 flex shrink-0 items-center [&>img]:rounded-full [&>img]:bg-background [&>img]:bg-foreground-on-dark [&>img]:p-px [&>img]:ring-1",
      className
    )}
    {...props}
  />
