...
**Purpose:** execute arbitrary relevant gestures with native timing, faithful visual feedback and independent cancellation. **Sources:** public Core Graphics posting/event sources [S17–S18](29-research-register.md#s17); display scheduling [S20](29-research-register.md#s20). These APIs do not establish universal hardware-equivalent event acceptance.
