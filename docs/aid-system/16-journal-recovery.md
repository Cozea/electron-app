...
**JRN-01:** lost response never duplicates effects. **JRN-02:** same key/different code conflicts. **JRN-03:** fault injection at every journal/dispatch boundary yields correct certainty. **JRN-04:** disk full prevents unjournaled input. **JRN-05:** old-generation callbacks are rejected. **JRN-06:** checkpoint answers are consumed once. **JRN-07:** active-generation key history is never silently forgotten. **JRN-08:** cleanup failures remain visible. **JRN-09:** read-only replay cannot reach native effects. **JRN-10:** recovery never automatically sends Undo or replays code to rebuild heap. G04/G08 are required for reconnectability claims.
