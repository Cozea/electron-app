...
titles use the named 22px token. There is no global `!important` rule normalizing text utilities.
...
performance scripts remain available; automatic application marks, jank logging, and
