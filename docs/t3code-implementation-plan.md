...
Upstream pin target: [pingdotgg/t3code](https://github.com/pingdotgg/t3code) `a3a8cbd60539b4af4de8f96c892dbd07a2b6c041` (Track Inv: `docs/substrate-t3-pin.md`)
...
## 7b. Wave 0 live roster (2026-08-26)

Cloud async VM limit is **3**. First wave launched:

| Track | bcId | URL | Branch intent |
| --- | --- | --- | --- |
| B Thread deletion | `bc-8882c863-3c69-5757-8cae-0933886be42d` | https://cursor.com/agents/bc-8882c863-3c69-5757-8cae-0933886be42d | `cursor/thread-deletion-cleanup-a002` |
| E NDJSON obs | `bc-685c5000-44c3-5113-825d-65fa1058cee6` | https://cursor.com/agents/bc-685c5000-44c3-5113-825d-65fa1058cee6 | `cursor/obs-ndjson-a002` |
| F Git status split | `bc-0766b355-c299-52a1-9780-cd238bb33c95` | https://cursor.com/agents/bc-0766b355-c299-52a1-9780-cd238bb33c95 | `cursor/git-status-local-remote-a002` |
| Inv Inventories | orchestrator (this PR) | — | `cursor/substrate-inventories-a002` |
| A / C / D | **queued** | — | Launch when a VM slot frees |
