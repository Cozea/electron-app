const ORIGINAL_TRANSFORMER_PATH = process.env.COZEA_NATIVE_PREVIEW_ORIG_BABEL_TRANSFORMER_PATH;
...
const { generateStorybookInternals } = require("./storybook/generate_storybook_internals.js");
...
function transformWrapper({ filename, src, ...rest }) {
  ...
  if (isTransforming("node_modules/react-native/Libraries/Core/InitializeCore.js")) {
    src = `${src};require("__COZEA_NATIVE_PREVIEW_lib__/runtime.js");`;
    ...
    if (version.startsWith("2.")) {
      src = `${src};require("__COZEA_NATIVE_PREVIEW_lib__/expo_router/expo_router_v2_plugin.js");`;
    } else if (version.startsWith("3.") || version.startsWith("4.")) {
      src = `${src};require("__COZEA_NATIVE_PREVIEW_lib__/expo_router/expo_router_plugin.js");`;
    } else if (version.startsWith("5.")) {
      src = `${src};require("__COZEA_NATIVE_PREVIEW_lib__/expo_router/expo_router_v5_plugin.js");`;
    } else if (version.startsWith("6.")) {
      src = `${src};require("__COZEA_NATIVE_PREVIEW_lib__/expo_router/expo_router_v6_plugin.js");`;
    } else if (version.startsWith("55.")) {
      src = `${src};require("__COZEA_NATIVE_PREVIEW_lib__/expo_router/expo_router_v55_plugin.js");`;
    }
  } else if (
    ...
    src = `module.exports = require("__COZEA_NATIVE_PREVIEW_lib__/preview.js");`;
  } else if (isTransforming("node_modules/@dev-plugins/react-native-mmkv/build/index.js")) {
    src = `require("__COZEA_NATIVE_PREVIEW_lib__/plugins/expo_dev_plugins.js").register("@dev-plugins/react-native-mmkv");${src}`;
  } else if (isTransforming("node_modules/redux-devtools-expo-dev-plugin/build/index.js")) {
    const pluginOverridePath = path.join(
      process.env.COZEA_NATIVE_PREVIEW_LIB_PATH,
      "plugins",
    ...
    // module.exports = require("__COZEA_NATIVE_PREVIEW_lib__/JSXRuntime/react-native-78-79/${jsxRuntimeFileName}")
    //
    ...
    if (
      ...
      src = `module.exports = require("__COZEA_NATIVE_PREVIEW_lib__/JSXRuntime/react-native-78-79/${jsxRuntimeFileName}");`;
    }
  } else if (
    // Apollo Client v4
    ...
    src = `require("__COZEA_NATIVE_PREVIEW_lib__/plugins/apollo-client-devtools.js");\n${src}`;
  } else if (
    ...
    src = `module.exports = require("__COZEA_NATIVE_PREVIEW_lib__/rn-internals/rn-internals-${majorMinorVersion}.js");`;
  } else if (isTransforming("lib/storybook/internal-imports/storybook_internals.js")) {
    src = generateStorybookInternals();
    ...
    src = src.replace(/"__COZEA_NATIVE_PREVIEW_REQUIRE_FETCH__"/g, fetchDeclaration);
  } else if (
    isTransforming("react-native-screens") &&
    filename.match(/components[\\/]Screen\.(js|tsx)$/)
  ) {
    const pluginPath = path.join(process.env.COZEA_NATIVE_PREVIEW_LIB_PATH, "screens", "screens_proxy.js");

    const pluginSrc = fs.readFileSync(pluginPath);
    src = `${src};\n${pluginSrc}`;
  }
