...
final class SkyLightSPI: @unchecked Sendable {
    ...
    func prepareSyntheticTargetFocus(
        targetPID: pid_t,
        targetWindowID: CGWindowID
        ...
        return SkyLightSyntheticFocusContext(
            activateTarget: plan.activateTarget,
            deactivateTarget: plan.deactivateTarget
        )
    }

    func beginSyntheticTargetFocus(_ context: SkyLightSyntheticFocusContext) throws {
        try postActivationCommand(context.activateTarget)
