...
function Input({
  ...
  const inputClassName = cn(
    "h-7.5 w-full min-w-0 rounded-[inherit] px-[calc(--spacing(3)-1px)] leading-7.5 outline-none placeholder:text-muted-foreground/72 [transition:background-color_5000000s_ease-in-out_0s]",
    size === "sm" && "h-6.5 px-[calc(--spacing(2.5)-1px)] leading-6.5",
