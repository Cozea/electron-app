...
import type { PullRequestReviewPosition } from "@cozea/contracts/t3"
...
export function isReviewCommentContext(value: unknown): value is ReviewCommentContext {
