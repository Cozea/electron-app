...
import { type ProviderDriverKind, type ProviderKind } from "@cozea/assistant-contracts"
...
export const ProviderInstanceIcon = memo(function ProviderInstanceIcon(props: {
  ...
  const Icon = PROVIDER_ICON_BY_PROVIDER[props.driverKind as ProviderKind] ?? null
  ...
  return (
    <span
      className={cn("relative isolate inline-flex shrink-0 items-center justify-center", props.className)}
      style={accentStyle}
