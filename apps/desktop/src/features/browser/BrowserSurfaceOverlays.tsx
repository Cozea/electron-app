  ...
  return (
    <>
      ...
      {state.controller !== "none" ? (
        <div className="pointer-events-none absolute left-3 top-3 z-40 rounded-full border border-border/70 bg-background/90 px-2.5 py-1 text-caption font-medium shadow-sm backdrop-blur">
